...
userRoutes.route('/lookup').get(function(req, res) {
	...
	console.log("request mememe newest" + JSON.stringify(username));
	if (username){
		console.log("here");
...
userRoutes.route('/lookup').post(function(req, res) {
	...
	console.log("request mememe1" + JSON.stringify(username));
...
userRoutes.route('/lookup2').post(function(req, res) {
	...
	let username = req.body.username;
	//let query = 
	console.log("request mememe2" + JSON.stringify(query));
...
userRoutes.route('/lookup3').post(function(req, res) {
	...
	let query = `{"username mememe new": "${usernameData}"}`
...
userRoutes.route('/login').post(function(req, res) {
	...
	console.log("Mongo query: " + JSON.stringify(query));
	if (/[^a-zA-Z]/.test(pass)&&!/[^a-zA-Z]/.test(uname)){
